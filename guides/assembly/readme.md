...
The controller is now ready to be programed. Please follow [this guide](../flashing/flashing.md) to install the bootloader and CFOC2 [firmware](../../firmware/latest) located in the firmware folder of the repository files.  Use these pins for flashing the bootloader with the st-link:
